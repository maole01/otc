...
<div class="container">
    <div class="coin-tab">
       <?php if(is_array($coinArr)): foreach($coinArr as $key=>$c): ?><a href="/buy/index/type/<?php echo (strtoupper($c['name'])); ?>" class="coin <?php echo ($coin_type=='9dc'?'current':''); ?>"><?php echo ($c["title"]); ?>(<?php echo (strtoupper($c["name"])); ?>)</a><?php endforeach; endif; ?>
    ...
    <table class="table buy">
        ...
        <?php if(!empty($adinfo)): if(is_array($adinfo)): foreach($adinfo as $key=>$v): ?><tr class="odd">
                    <td class="head-portrait pl-30">
                        <a href="<?php echo U('user/view',array('id'=>$v['userid']));?>" ><img class="user-head" src="<?php echo ($v["ue_img"]); ?>"  alt="">
                    ...
                    <?php switch($v["provider"]): case "1": ?><td>银行转账</td><?php break;?>
                    ...
                    <td class="td-price"><span style="margin-right:6px;"><?php echo ($v["price"]); ?></span> <?php echo (strtoupper($v["currency"])); ?></td>
                    <td class="pr-30"><a href="<?php echo U('Addetail/index',array('adid'=>$v['adid']));?>"  class="buy">出售</a></td>
                </tr><?php endforeach; endif; ?>
            <?php else: ?>
            <tr>
                <td colspan="5"><div class="no-record">
    ...
    <div class="page1" style="width:550px;height:50px"><?php echo ($page); ?></div>
</div>
