...
<div class="panel transactions-panel" style="width:80%;margin: 0 auto">
    <table class="table table-hover">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                <td><?php echo (addtime($v["orderaddtime"])); ?></td>
                <td>
                    <?php switch($v["order_type"]): case "0": ?>买入<?php break;?>
                        <?php case "1": ?>售出<?php break;?>
                        <?php case "3": ?>下线交易奖励<?php break; endswitch;?>
                    <?php echo (strtoupper($v["coin_type"])); ?>
                </td>
