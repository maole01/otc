...
<div class="fr right-wrap">
    <div class="setting-title">您信任的人</div>

    <div class="setting-panel">
        <?php if($trusting != null): if(is_array($trusting)): foreach($trusting as $key=>$v): ?><ul class="user-list" offset="0">
                    <li class="user-item">
                        <a href="/User/view/id/<?php echo ($v["id"]); ?>"><img class="user-head" src="<?php echo ($v["ue_img"]); ?>"></a>
                        <div class="user-info">
                            <a href="/User/view/id/<?php echo ($v["id"]); ?>" ><div class="user-name"><?php echo ($v["username"]); ?></div></a>
                        </div>
                        <div class="poster-info-cont clear-float">
                                    <span class="poster-info-item">
                                      <div class="item-d"><?php echo (getjycs($v["id"])); ?></div>
                                      <div class="item-n">交易次数</div>
                                    </span>
                            <span class="poster-info-item">
                                      <div class="item-d"><?php echo (getxrrs($v["id"])); ?></div>
                                      <div class="item-n">信任人数</div>
                                    </span>
                            <span class="poster-info-item">
                                      <div class="item-d"><?php echo (gethpl($v["id"])); ?> %</div>
                                      <div class="item-n">好评度</div>
                                    </span>
                            <span class="poster-info-item">
                                      <div class="item-d"><?php echo (getcjsl($v["id"])); ?>+ BTC</div>
            ...
            <div class="no-record">
                ...
                <div class="text-no-record">暂无相关信息</div>
            </div><?php endif; ?>
    </div>
