...
<div class="fr right-wrap">
    ...
    <div class="setting-panel secity-box">
        <ul class="safe-list">
            <li class="safe-item money-pw  <?php echo ($moneypwd?active:''); ?>">
                <div class="icon-money-pw"></div>
                <div class="fl">
                    <div class="opt-title">资金密码</div>
                    <div class="opt-decs">提现、修改安全设置时输入</div>
                </div>
                <div class="fr">

                   <!-- <a href="" class="btn line hasset">忘记资金密码</a>-->
                    <?php if($moneypwd != null): ?><a href="<?php echo U('Setting/moneypwd');?>" class="btn line hasset">修改</a>
                    <?php else: ?>
                        <a href="<?php echo U('Setting/setmoneypwd');?>" class="btn noset">立即设置</a><?php endif; ?>
            ...
            <li class="safe-item login-pw active">
                <div class="icon-login-pw"></div>
                <div class="fl">
                    <div class="opt-title">登录密码</div>
                    <div class="opt-decs">用于登录账户时输入</div>
                </div>
                <div class="fr">
                    <a href="<?php echo U('Setting/loginpwd');?>" class="btn line hasset">修改</a>
                </div>
                <div class="clear"></div>
            </li>

            <li class="safe-item google-auth <?php echo ($google?active:''); ?>">
                <div class="icon-google-a"></div>
                <div class="fl">
                    <div class="opt-title">谷歌验证</div>
                    <div class="opt-decs">绑定后，登录、提现、支付时需要谷歌二次验证</div>
                </div>
                <div class="fr">

                    <?php if($google != null): ?><a href="<?php echo U('setting/jcgoogle');?>" class="btn line">解除</a>
                        <?php else: ?>
                         <a href="<?php echo U('setting/googleauth');?>" class="btn noset">启用</a><?php endif; ?>
                </div>
            </li>
        </ul>
    </div>
